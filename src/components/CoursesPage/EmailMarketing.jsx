...
import introImg from "../../Assets/images/email.jpg";
import {
  Button,
  Card,
  CardActions,
  ...
  return (
    <div>
      <div style={{ padding: "20px" }}>
        ...
        >
          {" "}
   Advance Email Marketing Course Details
        </Typography>
            ...
            <Card className="card">
              ...
              <div className="card-content">
                <CardContent>
                  ...
                  >
                    Choose the Digital Marketing Course That Aligns Best With
                  ...
                  <div>
                    ...
                    <ol className="custom-tick-list">
                      <li>
                        Learn the fundamentals of digital marketing and
                        e-commerce to gain the skills needed to land an
                        entry-level job
                      </li>
                      <li>
